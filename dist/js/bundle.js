...
/* harmony export (immutable) */ __webpack_exports__["ADD_TODO"] = ADD_TODO;

const REMOVE_TODO = 'REMOVE_TODO';
/* harmony export (immutable) */ __webpack_exports__["REMOVE_TODO"] = REMOVE_TODO;

const TOGGLE_TODO = 'TOGGLE_TODO';
/* harmony export (immutable) */ __webpack_exports__["TOGGLE_TODO"] = TOGGLE_TODO;

const SET_VISIBILITY_FILTER = 'SET_VISIBILITY_FILTER';
/* harmony export (immutable) */ __webpack_exports__["SET_VISIBILITY_FILTER"] = SET_VISIBILITY_FILTER;
...
/* harmony export (immutable) */ __webpack_exports__["VisibilityFilters"] = VisibilityFilters;
...
var _actionCreators = __webpack_require__(51);
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    store.dispatch((0, _actionCreators.addTodo)('Turn on the PC first'));
    store.dispatch((0, _actionCreators.addTodo)('Turn on speakers'));
    store.dispatch((0, _actionCreators.toggleTodo)(0));
    store.dispatch((0, _actionCreators.setVisibilityFilter)(_actionTypes.VisibilityFilters.SHOW_ACTIVE));
    store.dispatch((0, _actionCreators.removeTodo)(0));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(20), __webpack_require__(45)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__actions_actionTypes_js__ = __webpack_require__(9);



const {SHOW_ALL} = __WEBPACK_IMPORTED_MODULE_1__actions_actionTypes_js__["VisibilityFilters"];
...
function visibilityFilter(state = SHOW_ALL , action) {
    switch (action.type) {
        case __WEBPACK_IMPORTED_MODULE_1__actions_actionTypes_js__["SET_VISIBILITY_FILTER"]:
...
function todos(state = [], action){
    switch (action.type) {
        case __WEBPACK_IMPORTED_MODULE_1__actions_actionTypes_js__["ADD_TODO"]:
            return [
                ...state,
                {
                    text : action.text,
        ...
        case __WEBPACK_IMPORTED_MODULE_1__actions_actionTypes_js__["REMOVE_TODO"]:
            return state.filter((todo, index) => {
                return index !== action.index
            });
        case __WEBPACK_IMPORTED_MODULE_1__actions_actionTypes_js__["TOGGLE_TODO"]:
...
/* harmony export (immutable) */ __webpack_exports__["removeTodo"] = removeTodo;
/* harmony export (immutable) */ __webpack_exports__["toggleTodo"] = toggleTodo;
/* harmony export (immutable) */ __webpack_exports__["setVisibilityFilter"] = setVisibilityFilter;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__actionTypes_js__ = __webpack_require__(9);


function addTodo(text){
    return {type : __WEBPACK_IMPORTED_MODULE_0__actionTypes_js__["ADD_TODO"], text }
}

function removeTodo(index){
    return {type : __WEBPACK_IMPORTED_MODULE_0__actionTypes_js__["REMOVE_TODO"], index }
}

function toggleTodo(index){
    return {type : __WEBPACK_IMPORTED_MODULE_0__actionTypes_js__["TOGGLE_TODO"], index }
}

function setVisibilityFilter(filter) {
    return {type : __WEBPACK_IMPORTED_MODULE_0__actionTypes_js__["SET_VISIBILITY_FILTER"], filter}
}
...
var _TodoList = __webpack_require__(57);
